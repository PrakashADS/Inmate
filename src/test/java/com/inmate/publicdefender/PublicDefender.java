...
//	 String s2="Message To Inmate 1";
	// if(s1.equalsIgnoreCase(s2))
	 ...
	 List<WebElement> MsgToInmate1=obj.findElements(By.xpath("//a[contains(text(),'Message To Inmate 1')]"));
		 for(int i=0;i<MsgToInmate1.size();i++)
		 {
 ...
 public void Create_Msgs(DataTable NewMesg) throws InterruptedException, AWTException
 {
	 List<List<String>> nm=NewMesg.raw();
	 POM_PubDefender pu=new POM_PubDefender(obj);
	 Thread.sleep(1000);
...
//	 for(int i=0;i<form1.size();i++)
 ...
 public void Document_Sort() throws Exception
	{
...
//	 pu.Documents.click();
	 ...
	 Thread.sleep(1000);
	 pu.btnSearch.click();
	 log.info("Document searched Success for edit");
	 Thread.sleep(1000);
	...
	for(int i=0;i<1;i++)
	
	 {
	    ...
	    pu.SaveBtn.click();
	    pu.btnOk.click(); 
	    log.info("Document saved Success");
	 }
 }
 ...
 public void DeleteDocs(DataTable dele) throws InterruptedException
 {
	...
	// pu.Documents.click(); 
	 ...
	 Thread.sleep(1000);
	 pu.btnSearch.click();
	 log.info("Document searched Success for delete");
	 Thread.sleep(1000);
...
public void LockUnlock() throws InterruptedException
{
	 ...
	 log.info("Lock unlocked Success");
}

@Then("^Perform Sorting in LockDown$")
public void LockDown_Sorting() throws InterruptedException
{
 POM_PubDefender pp = new POM_PubDefender(obj);
 pp.LockDown.click();
 Thread.sleep(1000);
 for(int t=0;t<2;t++)
 {
	 pp.Sort_LockDown_Kiosk_Inmate_Setting();
 }
 for(int t=0;t<2;t++)
 {
 pp.Sort_LockDown_Kiosk_Inmate_Status();
 }
 for(int t=0;t<2;t++)
 {
	 pp.Sort_LockDown_Kiosk_Inmate_LastAction();
 }
 for(int t=0;t<2;t++)
 {
	 pp.Sort_LockDown_Kiosk_LockDown_Info_KioskCode(); 
 }
 for(int t=0;t<2;t++)
 {
     pp.Sort_LockDown_Kiosk_LockDown_Info_POD();
 }
 for(int t=0;t<2;t++)
 {
	 pp.Sort_LockDown_Kiosk_LockDown_ComputerName();
 }
...
//	pu.DobEnd.sendKeys(inm1.get(5).get(1));
	...
	Thread.sleep(1000);
	pu.btnSearch.click();
	log.info("Inmate searched Success");
	Thread.sleep(1000);
	ScrollUp250();
...
public void InmateMessage(DataTable InmateMsg) throws InterruptedException, AWTException
{
	...
	*/
	obj.findElement(By.xpath("//*[@id='ContentPlaceHolder1_rptMessages_lblSubject_0']")).click();
	Thread.sleep(1500);       
	pu.BtnTranslate.click();
	log.info("Inmate Message translated Success");
	Thread.sleep(1500);
...
public void InmatePhotos(DataTable InmatePhoto) throws InterruptedException, AWTException
{
	...
	log.info("photos searched Success");
	Thread.sleep(1000);
...
public void Sorting_Inmate_Search() throws InterruptedException
{
	POM_PubDefender pp=new POM_PubDefender(obj); 
	Thread.sleep(1000);
	pp.InMate.click();
	Thread.sleep(1000);
	//pp.Sort_Inmates_Id();
	//pp.Sort_Inmate_LastName();
	//pp.Sort_Inmate_FirstName();
	//pp.Sort_Inmate_POD();
	//pp.Sort_Inmate_Gender();
    //pp.Sort_Inmate_DOB();
	//pp.Sort_Inmate_FreeCredits();
	pp.Sort_Inmate_Status();
}
...
//	 String s2="Message To Inmate 1";
	...
	/* pu.ReqStartDate.sendKeys(ms.get(2).get(1));
	 ...
	 pu.InmateLastName1.click();
		...
		Thread.sleep(1000);
		pu.SearchRequest.click();
		log.info("Request searched Success");
		Thread.sleep(1000);
	 List<WebElement> Msg2Inmate=obj.findElements(By.xpath("//a[contains(text(),'Message To Inmate 1')]"));
		 for(int i=0;i<1;i++)
		 {
			// pu.MsgToInmate1.click();
			 ...
			 log.info("Message To Inmate 1 clicked Success");
			 Thread.sleep(2000);
			 char ReplyMode='A';
				switch(ReplyMode)
				{
...
public void publicUsers(DataTable pubusers) throws InterruptedException, AWTException
{
	...
	pu.btnSearch.click();
	Thread.sleep(1000);
	pu.PublicUser_Search_Connections_Sort();
	log.info("public users searched Success");
	Thread.sleep(1000);
	...
	//  pu.Connections_InmateRelationship();
	//	pu.Connections_InmateConnStatus();
	//	pu.Connections_InmateConnCreditBalance();
	//	ScrollUp400();
		Thread.sleep(2000);
	//	pu.Connections_Inmate_Browser();
	//	pu.Connections_IpAddress();
	//	pu.Connections_DateTime();
...
public void pubUserPhotos(DataTable PubPhotos) throws InterruptedException, AWTException
{
	...
	for(int i=0;i<1;i++)
	{
		...
		case 1:
			...
			log.info("Photos Approved Success");
			break;
		case 2:
			Thread.sleep(1000);
			obj.findElement(By.id("ContentPlaceHolder1_btnReject")).click();
			log.info("Photos Rejected Success");
			break;
		}
		int y=1;
		switch(y)
...
public void PublicUser_Sorting() throws InterruptedException
{
	POM_PubDefender pp = new POM_PubDefender(obj);
	Thread.sleep(3000);
	pp.PublicUsers.click();
	Thread.sleep(1000);
//  pp.PublicUser_Search_Username_Sort();
//	pp.PublicUser_Search_LastName_Sort();
//	pp.PublicUser_Search_FirstName_Sort();
//	pp.PublicUser_Search_Email_Sort();
//	pp.PublicUser_Search_City_Sort();
//	pp.PublicUser_Search_State_Sort();
	pp.PublicUser_Search_Connections_Sort();
...
public void Keywords(DataTable Keywords) throws InterruptedException
{
	...
	for(int i=0;i<status2.size();i++)
	{
		...
		Thread.sleep(1000);
		pu.btnOk.click();
		log.info("Keyword Added Success");
	}
    Thread.sleep(2000);
	...
	Thread.sleep(1000);
	pu.btnSearch.click();
	log.info("Keyword searched Success");
	Thread.sleep(1000);
	...
	for(int i=0;i<statuss2.size();i++)
	{
		...
		Thread.sleep(1000);
		pu.btnOk.click();
		log.info("Keyword updated Success");
	}
	Thread.sleep(1000);
	pu.PublicUser_Keywords_Keyword_Sort();
//	pu.PublicUser_Keywords_WebUserAction_Sort();
//	pu.PublicUser_Keywords_InmateAction_Sort();
//	pu.PublicUser_Keywords_FilterType_Sort();
	//pu.PublicUser_Keywords_Status_Sort();
}
...
public void Notices(DataTable notices) throws InterruptedException, AWTException
{
	...
	Thread.sleep(1000);
	/*List<WebElement> SelectKiosk=obj.findElements(By.xpath("//label[contains(text(),'A')]"));
	Thread.sleep(1000);
	for(int i=0;i<1;i++)
	{
		Thread.sleep(1000);
		SelectKiosk=obj.findElements(By.xpath("//label[contains(text(),'A')]"));
		Thread.sleep(1000);
		SelectKiosk.get(i).click();
	}*/
	obj.findElement(By.xpath("//*[@id='ContentPlaceHolder1_cblSubCompany_0']")).click();
	Thread.sleep(1000);
	...
	Thread.sleep(1000);
	pu.btnOk.click();
	log.info("Notices Added Success");
	
	Thread.sleep(2000);
	pu.PublicUser_Notices_Title_Sort();
	pu.PublicUser_Notices_StartFrom_Sort();
	pu.PublicUser_Notices_EndBy_Sort();
	pu.PublicUser_Notices_status_Sort();
}
...
public void searchNotices(DataTable Kiosk) throws InterruptedException
{
	...
	Thread.sleep(1000);
	pu.btnSearch.click();
	log.info("Notices searched Success");
	Thread.sleep(1000);
   ...
   for(int i=0;i<1;i++)
   {
	 ...
	 //  pu.txtTitle.sendKeys("\u0008");
	   ...
	   pu.EndDate.clear();
		...
		Thread.sleep(1000);
		pu.btnOk.click();
		log.info("Notices updated Success");
		/*Thread.sleep(1000);
		pu.BackBtn.click();*/
   }
}
...
public void Reporting(DataTable Reportings) throws InterruptedException
{
	...
	Thread.sleep(1000);
	pu.SearchRequest.click();
	log.info("Reports Searched success");
	Thread.sleep(1000);
	...
	pu.PublicUser_Reporting_Form_Sort();
...
public void Create_Messasges() throws InterruptedException, AWTException
{
	 ...
	 Thread.sleep(1000);
	 pu.initiateMsg.click();
	 log.info("Initiate message clicked Success");
...
{    Thread.sleep(1000);
 ...
 public void ReqSearch2(DataTable Req) throws InterruptedException, AWTException
 {
	 ...
	 pu.GrievancesBtn.click();
	 Thread.sleep(1000);
	 Select SelpdForms=new Select(pu.PdFormSelect);
	 SelpdForms.selectByValue("53");
	 Thread.sleep(1000);
	 Select StatusSearch=new Select(pu.SelectReqStatus);
	 StatusSearch.selectByVisibleText(req1.get(0).get(1));
	Thread.sleep(1000);
...
/*	 pu.ReqEndDate.sendKeys(req1.get(2).get(1));
	 ...
	 Thread.sleep(1000);
	    ...
	    Thread.sleep(2000);
	    log.info("Request searched Success");
        List<WebElement> pdforms = obj.findElements(By.xpath("//a[contains(text(),'pd form')]"));
		Thread.sleep(2000);
		for(int i=0;i<pdforms.size();i++){
			Thread.sleep(2000);
		//	//WebElement wait1=new WebDriverWait(obj, 60).until(ExpectedConditions.elementToBeClickable(By.className("listoneGrid")));
			
			pdforms = obj.findElements(By.xpath("//a[contains(text(),'pd form')]"));
			Thread.sleep(2000);
		    pdforms.get(i).click();
		    Thread.sleep(2000);
		    obj.findElement(By.id("ContentPlaceHolder1_btnRejectRequest")).click();
		    Thread.sleep(2000);       
		    DelYesNo();
		}
			}
 ...
 public void SortReqSearch(DataTable Sortf1) throws InterruptedException, AWTException
 {
	...
	//     pu.f1_POD_Sort1();
	//     pu.f1_Created_Sort1();
	     pu.f1_RespondedOn_Sort1();
	//      pu.f1_Status_Sort1();
 }
 @Then("^Sort Message to Inmate$")
 public void Sort_MsgtoInmate(DataTable SortInitMsg) throws InterruptedException, AWTException
 {
	    List<List<String>> SortIM=SortInitMsg.raw();
		POM_PubDefender pu=new POM_PubDefender(obj);
		Thread.sleep(1500);
		 pu.GrievancesBtn.click();
		 Thread.sleep(1000);
		 ...
		 Thread.sleep(1000);
		Select rtypes=new Select(pu.ReqType);
		rtypes.selectByVisibleText(SortIM.get(0).get(1));
		Select rstatus=new Select(pu.ReqStatus);
		rstatus.selectByVisibleText(SortIM.get(1).get(1));
	/*	pu.ReqStartDate.clear();
	    pu.ReqStartDate.sendKeys(SortIM.get( 2).get(1));
	    pu.ReqEndDate.clear();
	    pu.ReqEndDate.sendKeys(SortIM.get(3).get(1));
	    pu.RespStartDate.clear();
		pu.RespStartDate.sendKeys(SortIM.get(4).get(1));
		pu.RespEndDate.clear();
		pu.RespEndDate.sendKeys(SortIM.get(5).get(1));
		pu.InmateLastName1.click();
		pu.LastNameSearch.sendKeys(SortIM.get(6).get(1));
		Robot rb=new Robot();
		rb.keyPress(KeyEvent.VK_TAB);
		Thread.sleep(2000);
		pu.InmateFrstName1.click();
		pu.FrstNameSearch.sendKeys(SortIM.get(7).get(1));
		Robot rb1=new Robot();
		rb1.keyPress(KeyEvent.VK_TAB);
		Thread.sleep(1000);*/
		pu.SearchRequest.click();
       ...
       pu.InitiateMsg_Form_Sort1();
     //   pu.InitiateMsg_InitiatedBySort1();
     //   pu.InitiateMsg_Inmate_Sort1();
 ...
 public void beforeMethod() {
	  PropertyConfigurator.configure("C:\\Users\\prakashd\\New_Workspace_Automation\\Inmate\\src\\test\\java\\log4jj.properties");
 ...
 */
	 ...
	 public void YesNo1() throws InterruptedException
	 {
		 int YesNo=1;
			switch(YesNo)
			{
	 ...
	 public void DelYesNo() throws InterruptedException
	 {
		 int YesNo=1;
			switch(YesNo)
			{
			case 1:
				...
				obj.findElement(By.id("btnYes")).click();
				Thread.sleep(1000);
				obj.findElement(By.id("ContentPlaceHolder1_txtRejectReason")).sendKeys("test reason");
				Thread.sleep(1000);
				obj.findElement(By.id("ContentPlaceHolder1_btnSubmitReject")).click();
				Thread.sleep(1000);
				obj.findElement(By.id("btnOk")).click();
				break;
			case 2:
