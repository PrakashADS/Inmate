...
public class KioskLogin {
	...
	public void Msgs() throws InterruptedException
	{
		...
		Thread.sleep(2000);
		pk.Messages.click();*/
		obj.findElement(By.name("ctl00$ContentPlaceHolder1$dldashboard$ctl00$imgApps")).click();
		/*Thread.sleep(1000);
		obj.findElement(By.tagName("html")).sendKeys(Keys.chord(Keys.CONTROL, Keys.SUBTRACT));*/
		
		List<WebElement> subj=obj.findElements(By.className("odd"));
		Thread.sleep(1000);
		for(int i=0;i<1;i++)
		{
			Thread.sleep(1000);
			subj=obj.findElements(By.className("odd"));
		    Thread.sleep(1000);
		    subj.get(0).click();
		...
		List<WebElement> subj1=obj.findElements(By.className("odd"));
		Thread.sleep(1000);
		for(int i=0;i<1;i++)
		{
			Thread.sleep(1500);
			subj1=obj.findElements(By.className("odd"));
		    Thread.sleep(2000);
		    subj1.get(0).click();
		    Thread.sleep(2000);
			obj.findElement(By.className("fa-reply")).click();
			Thread.sleep(2000);
			pk.MessageText.click();
			Thread.sleep(1000);
			 pk.VK_h.click();
			 Thread.sleep(1000);
			pk.MessageText.click();
	...
	public void photos() throws InterruptedException
	{
		...
		/*List<WebElement> subj2=obj.findElements(By.className("odd"));
		Thread.sleep(1000);
		subj2.get(0).click();
		for(int i=0;i<1;i++)
		{
			Thread.sleep(1000);
			subj2=obj.findElements(By.className("odd"));
		    Thread.sleep(1000);
		    subj2.get(0).click();
		    Thread.sleep(2000);
		    pk.Back1.click();
