...
//	 for(int i=0;i<form1.size();i++)
 ...
 public void UploadDocs(DataTable UploadDoc) throws InterruptedException
 {
	 ...
	 Thread.sleep(1000);
	 pu.SaveBtn.click();
	 pu.DocsTitle.sendKeys(Doc1.get(0).get(1));
...
/*	 pu.ReqEndDate.sendKeys(req1.get(2).get(1));
	 ...
	 Thread.sleep(1000);
		...
		for(int i=0;i<1;i++){
		    ...
		    case 1:
		    	  Thread.sleep(4000);
		    	  obj.findElement(By.xpath("//*[@id='ContentPlaceHolder1_btnAcceptRequest']")).click();
				  Thread.sleep(1000);
			      YesNo1();
			      break;
		    case 2:
		    	  Thread.sleep(1000);
		    	  obj.findElement(By.xpath("//*[@id='ContentPlaceHolder1_btnRejectRequest']")).click();
		    	  Thread.sleep(1000);
		    	  YesNo();
		    }
 ...
 @Then("^Goto pdform and Assign$")
 public void pdForm() throws InterruptedException
 {
	 Thread.sleep(1000);
